...
for org in path_to_org:
    ...
    savefile = open(args.save_way + org + '/{}_All_SB.fasta'.format(org), 'w')
    savefile.write('>dataset_of_all_SB')
    savefile.write('\n')
    savefile.write(All_SB)
    savefile.close()
    print('All synteny blocks for {}'.format(org))
...
for org in path_to_org:
    ...
    savefile.write('>dataset_of_all_SB_ends')
    savefile.write('\n')
